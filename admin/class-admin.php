...
class Admin {
	...
	public function __construct() {
		...
		$menu_settings = get_option( 'sturtevant_hide_addon_settings' );
    ...
    public function settings_page() {
		...
		add_options_page(
			...
			STURTEVANT_CHILD_NAME,
			'manage_options',
			STURTEVANT_ADMIN_SLUG . '-settings',
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'sturtevant-plugin', plugin_dir_url( __FILE__ ) . 'assets/css/admin.css', [], STURTEVANT_VERSION, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'sturtevant-plugin', plugin_dir_url( __FILE__ ) . 'assets/js/admin.js', [ 'jquery' ], STURTEVANT_VERSION, true );
