...
class Frontend {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'sturtevant-plugin', plugin_dir_url( __FILE__ ) . 'assets/css/frontend.css', [], STURTEVANT_VERSION, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'sturtevant-plugin', plugin_dir_url( __FILE__ ) . 'assets/js/frontend.js', [ 'jquery' ], STURTEVANT_VERSION, true );
